...
Being one of the first projects I undertook in my research career, this chapter describes the steps taken to operatealize novelty detection methods for use in planetary science for the Mars Science Laboratory (MSL) Curiosity rover.
...
By detailing the integration of these systems into the Mars Science Laboratory (MSL) tactical planning pipeline, this chapter demonstrates the practical challenges and solutions involved in adapting machine learning techniques for real-world scientific missions. 
