...
In order to better estimate ASTHROS' capabilities, we embarked on this project to use new observations from SOFIA, which has the same 2.5 meter telescope as ASTHROS, to map the electron density in Carina Nebula.
...
Additionally, this work publishes previously unpublished data from SOFIA providing the scientific community a first glimpse of [NII] 205 $\mu$m in Carina Nebula from the instrument. 
...
Finally, we compare our calculated values with the expected performance for the A
