...
\begin{table}[h]
    ...
    \begin{tabular}{l|l}
        ...
        Statistical Thresholding & Heuristic Rules \citep{cillis2018snowballs} \\
        Principal Component Analysis (PCA) \citep{wold1987principal} & Convolutional Neural Network (CNN)\citep{gu2018recent}
    \end{tabular}
...
This results in a time series of frames for each integration from a detector's pixel values being reset at the beginning of an exposure to the final accumulated pixel values at the end of an exposure ca\cite{casertano2022determining}.
