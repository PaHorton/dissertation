...
Because the new dimension added to the complexity of the data, we had to develop new methods for locating and classifying anomalies in the data, splitting the problem into two distinct tasks.
