...
There are many different sources that might cause errors in our detectors' data, such as read noise patterns, thermal noise, compression errors, and software errors, but in this paper, we are particularly interested in external and natural sources of errors \parencite{cillis2018snowballs}. 
...
\begin{table}[h]
    ...
    \begin{tabular}{l|l}
        ...
        Statistical Thresholding & Heuristic Rules \parencite{cillis2018snowballs} \\
        Principal Component Analysis (PCA) \parencite{wold1987principal} & Convolutional Neural Network (CNN)\parencite{gu2018recent}
    \end{tabular}
