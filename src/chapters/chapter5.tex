...
With the reconstructed values, we are able to calculate the residual ($Reconstructed_image - Original_image$) of the errors and identify where anomalies occur based on spikes in the ramp of the residual. 
...
This results in a time series of frames for each integration from a detector's pixel values being reset at the beginning of an exposure to the final accumulated pixel values at the end of an exposure \cite{2016jdox.rept......} \cite{casertano2022determining}.
