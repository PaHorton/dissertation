...
\begin{itemize}
    ...
    \item \texttt{RC}- current as a percentage of the maximum current\footnotemark[\ref{chap2/footnote:motor}].
    ...
    \item \texttt{VM} - The maximum velocity of the motor in steps per second\footnotemark[\ref{chap2/footnote:motor}].
