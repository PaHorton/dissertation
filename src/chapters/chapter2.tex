...
For the temperature sensors, we utilize the \texttt{temperature\_tool} tool provided by the manufactuer to read all of the temperature sensors for a given Smart PSU. 
