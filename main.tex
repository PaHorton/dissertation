...
\usepackage{algpseudocode}              % For writing algorithms
\usepackage{siunitx}               % For writing units and numbers with units
...
\newcommand*\defdate{June 2025}        %<Give month (written out fully) and year of
                                        %   the oral defense
...
\newcommand*{\gradyear}{2025}           %<Enter the graduation year, e.g. 2014
...
\hypersetup{                            % Set pdf metadata
 ...
 %pdfproducer={},                       % Let 'pdfproducer' be filled automatically
  ...
  hidelinks,                            % Links look like regular text (no colors, boxes)
...
\input{src/sections/abstract}             %<Enter the name of the .tex file containing your
...
\input{src/sections/dedication}           %<Enter the name of the .tex file containing your
                                        %   your dedication or omit this line and type in
                                        %   your dedication here.

\chapter*{Acknowledgments}              %~Acknowledgments are optional
\input{src/sections/acknowledgments}      %<Enter the name of the .tex file containing your
...
\include{src/chapters/chapter_msl}
\include{src/chapters/chapter_spectra}
\include{src/chapters/chapter_rst}
\include{src/chapters/chapter_carina}
\include{src/chapters/chapter_readout}
...
\input{src/sections/appendix}                       %~Insert your appendices here; I recommend to use
