...
\newcommand{\bibfilename}{%             %<Enter the name of the *.bib file containing the
  dis.bib%                   %   reference information for sources cited in
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mainmatter
% \include{src/sample/chapter}                     %<Insert your chapters here; I recommend to use
% \include{src/sections/chapter2}                     %   \include rather than \input for chapters
% \include{src/sections/chapter3}
\include{src/sections/chapter5}
...
% \input{src/sample/appendix}                       %~Insert your appendices here; I recommend to use
